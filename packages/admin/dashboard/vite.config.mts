...
export default defineConfig(({ mode }) => {
  ...
  // In production these are injected by @medusajs/admin-bundler. For standalone
  // dev (yarn dev in packages/admin/dashboard), default them so the React app
  // can boot without a Medusa backend running.
