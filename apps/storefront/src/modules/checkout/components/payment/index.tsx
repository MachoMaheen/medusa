...
/**
 * Wave 2.10 — Payment step (re-skinned).
 *
 * Surface tokens align with the rest of the checkout card stack. The
 * "Continue to review" CTA uses Medusa's default Button (which inherits the
 * brand-solid surface via `--button-inverted` from happilee-tokens.css), and
 * the Edit link adopts the brand-secondary-text hover swap used elsewhere.
 */
          ...
          {cart && paymentReady && activeSession ? (
            <div className="grid grid-cols-1 small:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col">
                ...
                <div
                  className="flex gap-2 text-sm text-ui-fg-subtle items-center"
                  data-testid="payment-details-summary"
                >
                  <Container className="flex items-center h-7 w-fit p-2 bg-ui-bg-subtle">
